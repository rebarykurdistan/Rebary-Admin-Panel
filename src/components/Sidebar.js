        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-6 border-b border-gray-200">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-gradient-to-br from-accent-orange to-accent-yellow rounded-lg flex items-center justify-center flex-shrink-0">
              ...
              {/* Close button — only shown on mobile, sits cleanly inside the header */}
              <button
                onClick={() => setIsMobileMenuOpen(false)}
          ...
          <div className="p-4 border-t border-gray-200 space-y-3">
            <div
              ...
              title={`Signed in as ${user?.email} · ${roleLabels[userRole]}`}
            >
              <div className="flex items-center gap-3">
